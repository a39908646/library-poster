import{g as h,j as t,aj as K,k as g,l as V,n as G,q as W,d as _,K as q,h as l,am as J,L as Q,u as L,z as O,an as U,C as N,c as j,ao as F,E as B,ap as X}from"./index-DiTpEquh.js";function E(e,d="default",a=[]){const{children:s}=e;if(s!==null&&typeof s=="object"&&!Array.isArray(s)){const i=s[d];if(typeof i=="function")return i()}return a}const Y=h([t("descriptions",{fontSize:"var(--n-font-size)"},[t("descriptions-separator",`
